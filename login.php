                                ...
                                <div class="col-lg-6">
                                    <div class="p-5">
                                        ...
                                        <form action="" method="post" class="user">
                                            ...
                                            <hr>
                                            <strong>Gunakan email dan password PESERTA yang sudah anda daftarkan di website <a href="www.fasilkomfest.com">www.fasilkomfest.com</a> </strong> <br>
                                            ...
                                            <?php if (isset($_POST['login'])) {
                                                    ...
                                                    $sql_login = mysqli_query($con, "SELECT * FROM teams_csos WHERE email = '$email' AND password = '$pass' AND login = '0'") or die(mysqli_error($con, ""));
